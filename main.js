...
function gotResult(error, results) {
    if(error){
        ...
        else if(results[0].label == "Hissing (turtle)"){
            img.src = "https://i.postimg.cc/G3Pfnt6L/little-turtie.gif";
            turtle = turtle+1;
            document.getElementById("detected").innerHTML = "Detected Turtle - "+ Turtle;
        }
        else if(results[0].label == "Hissing (snake)"){
            img.src = "https://i.postimg.cc/63XhMLWd/snakeyy.gif";
            snake = snake +1;
